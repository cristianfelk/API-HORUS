...
<script>
import { getUserById, updateUser } from '../services/apiService.js'; // Atualização da importação
...
.edit-user-container {
  ...
  height: 90vh;
  margin-top: 60px; /* Para evitar que o conteúdo fique oculto pela navbar */
}
